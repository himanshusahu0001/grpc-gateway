// Command protoc-gen-coredge-sdk is a plugin for Google protocol buffer
// compiler to generate golang SDK based on the RESTful HTTP server code
// generated by grpc gateway
//
// You rarely need to run this program directly. Instead, put this program
// into your $PATH with a name "protoc-gen-coredge-sdk" and run
//
//	protoc --coredge-sdk_out=output_directory path/to/input.proto
//
...
import (
	...
	"github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-coredge-sdk/internal/gengateway"
)
